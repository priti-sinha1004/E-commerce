...
<img  onClick={()=>setVisible(true)} src={assets.menu_icon} className='w-5 cursor-pointer sm:hidden cursor-pointer sm:hidden' alt="" />
...
<img  className='h-4 roate-180'src={assets.dropdown_icon} alt="" />
<p>Back</p>
</div>
